...
@RobotStatus.register_subclass("franka_aio_dora")
@dataclass
class FrankaAioDoraRobotStatus(RobotStatus):
    device_name: str = "Franka_V1"
    ...
    def __post_init__(self):
        ...
        self.specifications.camera = CameraStatus(
            information=[
                ...
                CameraInfo(
                    name="image_wrist_depth",
                    chinese_name="腕部深度摄像头",
                    type="深度相机",
                    width=640,
                    height=480,
                    is_connect=False
